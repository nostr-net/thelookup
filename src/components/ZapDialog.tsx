  ...
  <div ref={ref}>
    {invoice ? (
      ...
      <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
        ...
        <h3 className="text-lg font-semibold mb-2">No Lightning Address</h3>
        <p className="text-muted-foreground max-w-sm">
          The author of this content hasn't configured a lightning address for receiving zaps.
          You can still support them by finding their lightning address elsewhere or letting them know they should set one up!
        </p>
      </div>
    ) : (
      <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
        ...
        <p className="text-muted-foreground max-w-sm mb-4">
          You need to be logged in to send zaps. Please connect your Nostr account to continue.
        </p>
